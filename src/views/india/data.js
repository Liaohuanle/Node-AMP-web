...
const aboutContainerFile = {
  ...
  description: '/act/assets/india/english-share.png',
  shareRuleClick: {
...
const prizeList = {
  ...
  three: {
    ...
    desc: [
      `We will select Top 1 from each category as 1M Comedian, 1M Sports Guru, 1M Singer, 1M SpecialSkills Guru, 1M Foodie.`,
